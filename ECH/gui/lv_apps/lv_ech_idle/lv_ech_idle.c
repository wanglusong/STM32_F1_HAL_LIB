...
static void lv_poc_idle_time_task(void)
{
	...
	if(isInit == false)
	{
	  ...
	  idle_clock_style = (lv_style_t *)&theme_white_style_idle_big_clock;
      ...
      lv_obj_add_style(idle_date_label, LV_LABEL_PART_MAIN, idle_clock_style);//LV_LABEL_PART_MAIN
	}
...
lv_poc_activity_t * lv_poc_create_idle(void)
{
	...
	//memset(poc_setting_conf, 0, sizeof(nv_poc_setting_msg_t));
