...
static bool lv_poc_status_bar_init(void)
{
    ...
    poc_stabar_style = (lv_style_t *)&theme_white_style_status_bar;
...
static bool lv_poc_theme_init(void)
{
	...
	lv_style_set_text_font(&theme_white_style_list_btn_rel, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_list_btn_pr, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_list_btn_ina, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_win_header, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_idle_big_clock, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_idle_date_label, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_idle_msg_label, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_about_label, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_status_bar_time, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
	...
	lv_style_set_text_font(&theme_white_style_control, LV_STATE_DEFAULT, (lv_font_t *)LV_THEME_DEFAULT_FONT_NORMAL);
...
static bool lv_poc_init_stabar_time_label(void)
{
    ...
    label_style = (lv_style_t *)&theme_white_style_status_bar_time;
        ...
        lv_poc_control_text_t *control_text)
{
	...
	/*主题*/
    poc_display_style = (lv_style_t *)&theme_white_style_base;
